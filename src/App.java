    ...
    public static void menu() {
        try (Scanner entrada = new Scanner(System.in)) {
            ...
            switch (numero) {
                ...
                case 3:
                    System.out.println("Ingrese el nombre del candidato que desea eliminar:");
                    String candidatoEliminar = entrada.next();

                    if (nombre.contains(candidatoEliminar)) {
                        nombre.remove(candidatoEliminar);
                ...
                case 4:
                    System.out.println("Ingrese el nombre del candidato que desea buscar:");
                    String candidatoBuscar = entrada.next();

                    if (nombre.contains(candidatoBuscar)) {
                        System.out.println("Candidato encontrado: " + candidatoBuscar);
                    } else {
                        System.out.println("El candidato no se encontró en la lista.");
                    }
